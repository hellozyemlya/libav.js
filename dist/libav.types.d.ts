...
AVFrame_best_effort_timestamp(ptr: number): Promise<number>;
AVFrame_best_effort_timestamp_s(ptr: number,val: number): Promise<void>;
AVFrame_best_effort_timestamphi(ptr: number): Promise<number>;
AVFrame_best_effort_timestamphi_s(ptr: number,val: number): Promise<void>;
...
AVFrame_best_effort_timestamp_sync(ptr: number): number;
AVFrame_best_effort_timestamp_s_sync(ptr: number,val: number): void;
AVFrame_best_effort_timestamphi_sync(ptr: number): number;
AVFrame_best_effort_timestamphi_s_sync(ptr: number,val: number): void;
